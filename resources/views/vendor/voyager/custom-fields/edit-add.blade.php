                    ...
                    <form role="form"
                        ...
                        <div class="panel-body">
                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                @if($row->getTranslatedAttribute('display_name') !== 'Options')
                                    <div
                                ...
                                @else
                                    ...
                                    <script>
                                        $(function () {
                                            ...
                                            myAppendGrid.load([
                                                @if(json_decode($dataTypeContent->options, true))
                                                    @foreach(json_decode($dataTypeContent->options, true) as $option)
