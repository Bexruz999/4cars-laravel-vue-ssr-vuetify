                        ...
                        <div class="panel-body">
                            ...
                            @foreach($dataTypeRows as $row)
                                ...
                                @php
                                    ...
                                    /*$optionType = $dataTypeContent->type*/
                                @endphp
                                ...
                                @if($row->getTranslatedAttribute('display_name') !== 'Image Link')
                                    <div
                                ...
                                @else
                                    ...
                                    <script>
                                        $(function () {
                                            ...
                                            myAppendGrid.load([
                                                @if(json_decode($dataTypeContent->image_link, true))
                                                    @foreach(json_decode($dataTypeContent->image_link, true) as $option)
                                                        {value: "{{ $option }}"},
                                                    @endforeach
                                                @else
                                                    {value: "", key: ""}
